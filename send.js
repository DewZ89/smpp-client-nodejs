...
var session = smpp.connect("smpp://jgateway.arolitec.com:2777") // PROD SMSC
...
session.bind_transceiver(
  {
    system_id: "dewz10", // You can generate SMPP System_ID TCXC buyer portal under accounts page
    password: "yopwvt83", // You can define SMPP password in TCXC buyer portal under accounts page
  },
  function (pdu) {
    if (pdu.command_status == 0) {
      ...
      session.submit_sm(
        {
          destination_addr: "2250741165280", // The destination phone number you want to send a message to
